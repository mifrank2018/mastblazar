...
COIN_DAEMON='hashrentalcoind'
COIN_CLI='hashrentalcoin-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO=''
COIN_TGZ='https://github.com/HashRentalCoin/hashrentalcoin/releases/download/1/linux.Ubuntu.16.04.V.1.0.2.tar.gz'
